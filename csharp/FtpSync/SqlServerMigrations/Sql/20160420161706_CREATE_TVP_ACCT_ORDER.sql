CREATE TYPE [dbo].[TVP_ACCT_ORDER] AS TABLE
( 
	...
	[ORD_TOT] [numeric](11, 2) NULL DEFAULT (0),
	[ORD_TAX] [numeric](11, 2) NULL DEFAULT (0),
	[ORD_DUE] [numeric](11, 2) NULL DEFAULT (0),
	[ACT_TOTAL] [numeric](11, 2) NULL DEFAULT (0),
	[ACT_TAX] [numeric](11, 2) NULL DEFAULT (0),
	[ACT_DUE] [numeric](11, 2) NULL DEFAULT (0),
	[ACT_PAYMENTS] [numeric](11, 2) NULL DEFAULT (0),
	[ACT_CREDITS] [numeric](11, 2) NULL DEFAULT (0),
	[ORD_CREDITS] [numeric](11, 2) NULL DEFAULT (0),
	...
	[FC_ORD_TOT] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ORD_TAX] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ORD_DUE] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ACT_TOT] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ACT_DUE] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ACT_PAYMENTS] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ACT_CREDITS] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ORD_CREDITS] [numeric](11, 2) NULL DEFAULT (0),
	[FC_ACT_TAX] [numeric](11, 2) NULL DEFAULT (0),
